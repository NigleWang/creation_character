...
1. **装饰物**：保持原场景 / 角色默认（Teo→眉框眼镜）/ 墨镜 / 耳机 / 无装饰
...
- `Teo 戴耳机，衣服 navy` → 解析后直接写 manifest
...
```text
✅ 场景已分析。换脸前请确认：
Kai 装饰物：1保持原场景 2角色默认 3墨镜 4耳机
Kai 上衣：1保持(浅蓝) 2藏青 3白 4黑
回复数字或「全部保持原场景」→ 我再生成
```

用户可一条消息跳过询问：`@virtual-couple @Kai 全部保持原场景`
